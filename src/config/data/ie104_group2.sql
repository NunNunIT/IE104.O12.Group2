...
(1, 5, 1, '2023-11-30 13:49:22'),
(1, 6, 1, '2023-12-15 23:49:08'),
(1, 10, 1, '2023-11-30 13:21:05'),
(1, 13, 1, '2023-11-30 02:10:56'),
...
(5, 1, 1, 'Phan Nguyễn Hải Yến', '0987654321', '2023-11-02', '2023-11-05', '456 Le Van Luong Street, Ward 10, District 2, Ho Chi Minh City', 'Giao vào giờ hành chính 8h đến 16h', 8980000, 8980000, 1, '2023-11-30', 0, 'Đã hủy'),
...
(39, 1, 1, 'Phan Nguyễn Hải Yến', '0987654321', '2023-12-05', '0000-00-00', 'tới nhà Nhung nguyễn Phường 4 Quận 8 Hồ Chí Minh', '', NULL, 0, 1, '0000-00-00', 1, 'Đang giao hàng');
...
(14, 13, 4, 'Hồng nhạt - 128GB', 25490000, 100, 1, 1, '2023-11-29', 1),
...
(5, '0987654325', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Trần Thiên Lộc', 'user5.png', '1990-01-01 00:00:00', 'Nam', 'user5@example.com', '0987654325', 'Hà Nội', '2023-01-01', 1),
(6, '0987654326', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Nguyễn Phú Cường', 'user6.png', '1999-03-03 00:00:00', 'Nam', 'user6@example.com', '0987654326', 'Đà Nẵng', '2023-01-01', 1),
(7, '0987654327', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Phan Thanh Danh', 'user7.png', '1999-03-03 00:00:00', 'Nam', 'user7@example.com', '0987654327', 'Đồng Nai', '2023-01-01', 1),
(8, '0987654328', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Mai Văn Tiên', 'user8.png', '1999-03-03 00:00:00', 'Nam', 'user8@example.com', '0987654328', 'Đà Nẵng', '2023-01-01', 1),
(9, '0987654329', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Tô Thanh Lộc', 'user9.png', '1999-03-03 00:00:00', 'Nam', 'user9@example.com', '0987654329', 'Bình Phước', '2023-01-01', 1),
(10, '0987654330', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Nguyễn Nhựt Tiến', 'user10.png', '1999-03-03 00:00:00', 'Nam', 'user10@example.com', '0987654330', 'Cần Thơ', '2023-01-01', 1),
(11, '0987654331', '$2a$08$eOIGRuOHME.s5d0c740JCuAtlEMupog/udCJwqHn9PC1jAQXPPX.e', 'Lý Văn Nghĩa', 'user11.png', '1999-03-03 00:00:00', 'Nam', 'user11@example.com', '0987654331', '', '2023-01-01', 1),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_dashboard`  AS SELECT `dashboard_customer`.`customer_count` AS `customer_count`, `dashboard_order`.`quantity_sold` AS `quantity_sold`, `dashboard_order`.`revenue` AS `revenue` FROM ((select count(0) AS `customer_count` from `customers`) `dashboard_customer` join (select count(0) AS `quantity_sold`,sum(`orders`.`order_total_after`) AS `revenue` from `orders` where `orders`.`order_is_paid` = 1) `dashboard_order`) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_user`  AS SELECT `users`.`user_id` AS `user_id`, `users`.`user_login_name` AS `user_login_name`, `users`.`user_password` AS `user_password`, `users`.`user_name` AS `user_name`, `users`.`user_avt_img` AS `user_avt_img`, `users`.`user_birth` AS `user_birth`, `users`.`user_sex` AS `user_sex`, `users`.`user_email` AS `user_email`, `users`.`user_phone` AS `user_phone`, `users`.`user_address` AS `user_address`, `users`.`user_register_date` AS `user_register_date`, `users`.`user_active` AS `user_active`, `customers`.`customer_id` AS `customer_id`, `staffs`.`staff_id` AS `staff_id`, `staffs`.`staff_role` AS `staff_role`, `staffs`.`staff_description` AS `staff_description` FROM ((`users` left join `customers` on(`users`.`user_id` = `customers`.`user_id`)) left join `staffs` on(`users`.`user_id` = `staffs`.`user_id`)) ;
...
--
ALTER TABLE `feedbacks`
  MODIFY `feedback_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=740;
