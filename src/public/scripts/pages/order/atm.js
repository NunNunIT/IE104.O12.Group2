document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("bank-vietcombank").style.borderColor = "var(--primary-color-1)"
    ...
    document.getElementById("bank-vietcombank").addEventListener("click", function () {
        document.getElementById("pay_info-vietcombank").style.display = "block";
        document.getElementById("pay_info-bidv").style.display = "none";
        document.getElementById("bank-vietcombank").style.borderColor = "var(--primary-color-1)"
        document.getElementById("bank-bidv").style.borderColor = "var(--outline-gray)"
    ...
    document.getElementById("bank-bidv").addEventListener("click", function () {
        ...
        document.getElementById("bank-bidv").style.borderColor = "var(--primary-color-1)"
        document.getElementById("bank-vietcombank").style.borderColor = "var(--outline-gray)"
    });
